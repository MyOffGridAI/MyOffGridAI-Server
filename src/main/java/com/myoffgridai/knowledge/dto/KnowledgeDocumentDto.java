 ...
 * @param isShared         whether the document is shared with all users
 * @param isOwner          whether the requesting user owns this document
 * @param ownerDisplayName display name of the owner (null if isOwner is true)
 */
